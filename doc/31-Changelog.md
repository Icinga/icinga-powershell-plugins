...
* [#385](https://github.com/Icinga/icinga-powershell-plugins/pull/385) Adds new provider for Invoke-IcingaCheckEventLog to improve performance and fix memory leaks

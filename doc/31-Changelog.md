...
* [#411](https://github.com/Icinga/icinga-powershell-plugins/pull/411) Adds argument `Limit100Percent` to `Invoke-IcingaCheckCPU` for limiting each threads CPU usage to 100%

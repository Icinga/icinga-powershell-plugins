...
* [#435](https://github.com/Icinga/icinga-powershell-plugins/issues/435) Adds support for `Invoke-IcingaCheckScheduledTask` to filter for a path segments to display all containing objects

...
| Enabled | SwitchParameter | false | False | Used to specify whether the firewall profiles should be enabled or disabled.<br /> <br /> -Enabled $TRUE translates to enabled, while not being specified translates to disabled. |

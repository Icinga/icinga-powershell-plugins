...
| OverrideNotOk | String | false | Critical | This argument will allow you to override the default behavior of the plugin in case a service is not returning OK.<br /> By default, it will report CRITICAL but you can set with this argument if the service state should be<br /> OK, WARNING, CRITICAL or UNKNOWN instead |

...
| WarningLastRunTime | String | false |  | Allows to specify a time interval, on which the check will return warning based on the last run time<br /> of a task and the current time. The value will be subtracted from the current time<br /> <br /> Values have to be specified as time units like, -10m, -1d, -1w, -2M, -1y |
| CriticalLastRunTime | String | false |  | Allows to specify a time interval, on which the check will return critical based on the last run time<br /> of a task and the current time. The value will be subtracted from the current time<br /> <br /> Values have to be specified as time units like, -10m, -1d, -1w, -2M, -1y |
| WarningNextRunTime | String | false |  | Allows to specify a time interval, on which the check will return warning based on the next run time<br /> of a task and the current time. The value will be added to the current time<br /> <br /> Values have to be specified as time units like, 10m, 1d, 1w, 2M, 1y |
| CriticalNextRunTime | String | false |  | Allows to specify a time interval, on which the check will return critical based on the next run time<br /> of a task and the current time. The value will be added to the current time<br /> <br /> Values have to be specified as time units like, 10m, 1d, 1w, 2M, 1y |
